...
let BASE_modeurl =
  "http://8.134.70.156:8090//pop_perceive/pop-rel-int/getOOnes/?code=";
let BASE_sumurl =
  "http://8.134.70.156:8090//pop_perceive/pop-rel-int/getOOnesByCity/?code=";
export default {
  data() {
    return {
      tripOptions: [
  ...
  methods: {
    changeMode(val) {
      ...
      switch (val) {
        ...
        case "d":
          BASE_modeurl =
            "http://8.134.70.156:8090//pop_perceive/pop-rel-int/getDOnes/?code=";
          BASE_sumurl =
            "http://8.134.70.156:8090//pop_perceive/pop-rel-int/getDOnesByCity/?code=";
