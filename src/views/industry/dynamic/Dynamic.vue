...
export default {
  data() {
    return {
      ...
      showLegend: true,
      legendItems: [
        { index: 1, text: "采矿业", style: "backgroundColor:#8B4513" },
        {
          index: 2,
          text: "电力、热力、燃气及水生产和供应业",
          style: "backgroundColor:#ff80ab",
        },
        { index: 3, text: "房地产业", style: "backgroundColor:#ADD8E6" },
        { index: 4, text: "国际组织", style: "backgroundColor:#DAA520" },
        { index: 5, text: "建筑业", style: "backgroundColor:#FFA500" },
        {
          index: 6,
          text: "交通运输、仓储和邮政业",
          style: "backgroundColor:#FF0000",
        },
        { index: 7, text: "教育", style: "backgroundColor:#FFFF00" },
        { index: 8, text: "金融业", style: "backgroundColor:#00008B" },
        {
          index: 9,
          text: "居民服务、修理和其他服务业",
        ...
        { index: 12, text: "批发和零售业", style: "backgroundColor:#FFFF00" },
        {
          index: 13,
          text: "水利、环境和公共设施管理业",
          style: "backgroundColor:#A9A9A9",
        },
        { index: 14, text: "卫生和社会工作", style: "backgroundColor:#FFC0CB" },
        {
          index: 15,
          text: "文化、体育和娱乐业",
        ...
        { index: 17, text: "制造业", style: "backgroundColor:#0000FF" },
        { index: 18, text: "住宿和餐饮业", style: "backgroundColor:#800080" },
        {
          index: 19,
          text: "租赁和商务服务业",
          style: "backgroundColor:#808080",
