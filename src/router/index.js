...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      //   path: '/energy',
      //   name: '运行监测',
      //   meta: { title: "运行监测", icon: "wlsys-nenghao" },
      //   component: () => import('@/views/energy/index.vue'),
      //   children: [
      //     {
      //       path: '/energy/electricity',
      //       meta: { title: "能耗监测", icon: "el-icon-position" },
      //       component: () => import('@/views/energy/Electricity.vue'),
      //     },
      //     {
      //       path: '/energy/fengtou',
      //       meta: { title: "风投监测", icon: "el-icon-position" },
      //       component: () => import('@/views/energy/Fengtou.vue'),
      //     },
      //     {
      //       path: '/energy/zhuanli',
      //       meta: { title: "专利合作", icon: "el-icon-position" },
      //       component: () => import('@/views/energy/Zhuanli.vue'),
      //     },
      //   ]
      // }
      // {
